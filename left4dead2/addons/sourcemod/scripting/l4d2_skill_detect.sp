...
public void OnPluginStart()
{
	...
	g_cvarRepHunterDP		= CreateConVar("sm_skill_report_hunterdp", "0", "Enable hunter DP reporting.", FCVAR_NONE, true, 0.0, true, 1.0);
	...
	g_cvarDeathChargeHeight = CreateConVar("sm_skill_deathcharge_height", "300", "How much height distance a charger must take its victim for a deathcharge to be reported.", FCVAR_NONE, true, 0.0, false);
