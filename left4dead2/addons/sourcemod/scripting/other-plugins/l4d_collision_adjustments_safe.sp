...
public void OnPluginStart()
{
	...
	GetCvars();
	g_hCvarRockFix.AddChange// Hook(ConVarChanged);
	g_hCvarPullThrough.AddChange// Hook(ConVarChanged);
	g_hCvarRockThroughIncap.AddChange// Hook(ConVarChanged);
	if(!g_bL4D2Version) g_hCvarCommonThroughWitch.AddChange// Hook(ConVarChanged);
	g_hCvarHunterThroughInacp.AddChange// Hook(ConVarChanged);
	g_hCvarSIThroughWitch.AddChange// Hook(ConVarChanged);
