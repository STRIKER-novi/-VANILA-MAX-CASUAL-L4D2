...
::AdminSystem <-
{
	...
	[
		...
		"Type these commands into the chat window (or scripted_user_func in console) to perform the following actions.",
		"---",
		"add_admin <playername> - Gives a player admin privileges.",
		"adminmode <bool> - If false all players have access to admin commands (Default: true).",
		"ban <playername> - Bans a player from the server.",
		"kick <playername> - Bans a player from the server.",
		"password <password> - Used to grant a player admin privileges if they enter the password set for AdminPassword in settings.txt.",
		"remove_admin <playername> - Removes admin privileges from a player.",
		"---",
		"adrenaline <playername> <duration> - Set duration of adrenaline effect for player.",
		"alarmcar - Spawn an alarm car at your crosshair's location.",
		"ammo <playername> <int> - Gives ammo to a player.",
		"barrel <amount> - Spawn x explosive barrels at crosshair.",
		"bash <playername> <enable/disable/limit> - Sets if a player is allowed to bash.",
		"chase <playername> - Make infected chase player.",
		"cleanup - Removes all spawned entities from the map.",
		"console <command> - Simulate a console command.",
		"cvar <cvarname> <value> - Set cvar to desired value.",
		"defib <playername> - Defibrillate a dead player.",
		"director <start/stop> - Start or stop the Director from spawning infected.",
		"door <saferoom> - Spawn a door at crosshair (Set 'saferoom' to spawn saferoom door).",
		"drop <playername> <weapon> - Make player drop a weapon.",
		"drop_fire - Drops a Molotov at your crosshair.",
		"drop_spit - Drops Spitter goo at your crosshair.",
		"dummy <modelname> <weaponname> <animationname> - Spawn a commentary dummy with desired model, weapon and animation.",
		"endgame - Force mission to end and roll stats.",
		"ent_fire <target> <action> <value> - Fire an ent_fire for target entity.",
		"entity <classname> - Spawn an entity at crosshair.",
		"exec <filename> - Execute multiple cvars from a file in the ems directory.",
		"extinguish <playername> - Extinguishes a player if on fire.",
		"finale <start/rescue> - Start finale or force rescue to arrive.",
		"fireworkcrate <amount> - Spawn x firework crates at crosshair.",
		"fly <playername> - Toggles flying mode for player.",
		"freeze <playername> - Make player freeze in-place.",
		"friction <playername> <value> - Set player friction.",
		"gascan <amount> - Spawn x gascans at crosshair.",
		"give <playername> <weapon> <skin> - Give player a weapon with optional skin number.",
		"god <playername> - Toggles god mode for player.",
		"gravity <playername> <value> - Set player gravity.",
		"gun <autoshotgun/hunting_rifle/rifle> - Spawn a weapon that auto-fires at infected at crosshair location.",
		"health <temp/perm> - Converts health value from permanent to temporary.",
		"help - Print list of Admin System commands in console.",
		"hurt <playername> <amount> - Hurt a player for x damage.",
		"ignite <playername> - Ignite player on flames.",
		"incap <playername> - Incapacitate a player.",
		"infinite_ammo <playername> - Toggles infinite ammo for player (No Reload).",
		"infinite_upgrade <playername> <upgradename> - Give player infinite upgrade ammo (explosive_ammo/incendiary_ammo).",
		"kill <playername> - Kills a player.",
		"l4d1_survivor <playername> - Spawns a L4D1 survivor bot on team 4 (Bill/Francis/Louis/Zoey).",
		"limit <common/maxspecials> - Sets infected limits.",
		"max_health <playername> <int> - Set max health for survivor/infected.",
		"melee <meleename> - Spawn a melee weapon at crosshair (Enter 'any' for random melee).",
		"minigun <l4d1> - Spawn a minigun at crosshair (Set 'l4d1' to spawn L4D1 variant).",
		"move <botname> - Make survivor bot move to your crosshair's location.",
		"netprop <playername> <propname> <value> - Set network property on player.",
		"noclip <playername> - Toggle noclip mode on player.",
		"oxygentank <amount> - Spawn x oxygen tanks at crosshair.",
		"particle <particlename> - Spawn a particle.",
		"prop <dynamic/physics/ragdoll> <modelname> <aimed> - Spawn a prop at crosshair (Optional aimed param to aim prop toward you).",
		"propanetank <amount> - Spawn x propane tanks at crosshair.",
		"reload <playername> - Make player reload their active weapon.",
		"remove <playername> <weapon> - Remove a weapon from a player.",
		"rescue <playername> - Rescue player from closet.",
		"resource <amount> - Spawn x resource packs in the Holdout Mutation only.",
		"respawn <playername> - Revives a survivor if dead, and teleports them back to where initially spawned.",
		"restart - Force map to restart.",
		"revive <playername> - Revive an incapacitated player.",
		"revivecount <playername> <int> - Set a player's revive count.",
		"script <code> - Execute VScript code manually.",
		"sound <playername> <soundname> - Play sound for player (Enter 'stop' to stop playing sound).",
		"spawn_ammo <modelname> - Spawn an ammo pile at crosshair (Optional modelname to override ammo pile model).",
		"speak <playername> <scenename> - Make player speak a scene.",
		"speed <playername> <value> - Set player movement speed.",
		"stagger <playername> <away> - Stagger player forwards (Optional 'away' param will stagger player away from issuer).",
		"survivor <playername> - Spawns an additional survivor bot on team 2 (Bill/Francis/Louis/Zoey).",
		"switch_to <playername> <weaponname/slotindex> - Make player switch to desired weapon in their inventory.",
		"timescale <float> - Set timescale for slow motion or faster game time.",
		"unlimited_ammo <playername> - Toggles unlimited ammo for player (Reload).",
		"upgrade_add <playername> <upgradename> - Give player an upgrade (laser_sight/explosive_ammo/incendiary_ammo).",
		"upgrade_remove <playername> <upgradename> - Remove an upgrade from player (laser_sight/explosive_ammo/incendiary_ammo).",
		"use <playername> - Make player invoke the 'use' key on entity currently being looked at.",
		"velocity <playername> <value> - Set player velocity.",
		"vomit <playername> - Cover player in vomit.",
		"warp <playername> <playername> - Teleport player to your location (Enter second playername to teleport to that player instead).",
		"warp_battlefield - Teleport all Survivors to the battlefield.",
		"warp_checkpoint - Teleport all Survivors to the ending checkpoint.",
		"warp_finale - Teleport all Survivors to the finale.",
		"warp_here <playername> - Teleport player to your crosshair.",
		"warp_saferoom <playername> - Teleport player to ending saferoom.",
		"weapon <weaponname> - Spawn a weapon at crosshair location.",
		"z_spawn <zombiename> <amount> <auto> - Spawn desired zombie at crosshair (Enter 'auto' to auto spawn zombie).",
		"zombie <zombietype> <amount> <auto> - Spawn a specific common zombie at crosshair (Enter 'auto' to auto spawn zombie).",
		"---",
		//"say <playername/text> <text> - Send message to all players (Enter player's name to force that player to say text).",
		//"client <playername> <command> - Invoke console command on client.",
	]
	ValidCmds =
	[
		"add_admin",
...
::AdminSystem.LoadSettings <- function ()
{
	...
	foreach (setting in settings)
	{
		...
		{
			//setting = Utils.StringReplace(setting, "=", "<-");
			local compiledscript = compilestring("AdminSystem.Settings." + setting);
			compiledscript();
		}
	}
}
...
::AdminSystem.IsPrivileged <- function ( player )
{
	...
	if ( !AdminSystem.Settings.AdminsOnly )
		AdminSystem.Vars.AllowAdminsOnly = false;
	
	if ( !(steamid in ::AdminSystem.Admins) && AdminSystem.Vars.AllowAdminsOnly )
	{
		AdminSystem.PrintClientMessage( player, "You do not have access to this command." );
		return false;
	}
...
::AdminSystem.KickPlayer <- function( player )
{
	...
	if ( AdminSystem.Settings.DisplayMsgs )
...
function Notifications::OnRoundStart::AdminLoadFiles()
{
	...
	if ( settingList != null )
	{
		...
		local newSettingList = "";
		foreach( setting, value in ::AdminSystem.Settings )
		{
			if ( settingList.find( setting ) == null )
			{
				local val = value;
		...
		if ( newSettingList != "" )
		{
			settingList = settingList + newSettingList;
	...
	if ( ::AdminSystem.Settings.RetainCvars && ::AdminSystem.Vars.ChangedCvars.len() )
	{
		foreach( cvar, value in ::AdminSystem.Vars.ChangedCvars )
...
{
	if ( AdminSystem.Settings.EnableIdleKick && !(player.GetSteamID() in ::AdminSystem.Admins) )
		Timers.AddTimerByName( "KickTimer" + AdminSystem.GetID( player ).tostring(), AdminSystem.Settings.IdleKickTime, false, AdminSystem.KickPlayer, player );
}
...
function EasyLogic::OnUserCommand::AdminCommands(player, args, text)
{
	...
	if ( AdminSystem.ValidCmds.find( Command ) == null )
		return;
	...
	switch ( Command )
	{
		...
		case "password":
		{
			if ( AdminSystem.Settings.AdminPassword == "" )
				return;
			
			local Password = GetArgument(1);
			
			if ( Password == AdminSystem.Settings.AdminPassword )
			{
				local admins = FileToString("admin system/admins.txt");
				local steamid = player.GetSteamID();
				if ( steamid == "BOT" )
...
::AdminSystem.KickCmd <- function ( player, args )
{
	...
	else
	{
		...
		if ( steamid == "BOT" )
		{
			if ( Target.GetSurvivorCharacter() > 3 && Target.GetTeam() == SURVIVORS )
				Target.SetTeam( L4D1_SURVIVORS );
...
::AdminSystem.SurvivorCmd <- function ( player, args )
{
	...
	if ( Survivor == "bill" )
		...
		Utils.SpawnSurvivor(ZOEY, EyePosition);
...
::AdminSystem.CvarCmd <- function ( player, args )
{
	...
	{
		Convars.SetValue( Cvar, Value );
		if ( ::AdminSystem.Settings.RetainCvars )
			AdminSystem.Vars.ChangedCvars[Cvar] <- Value;
	}
}
...
{
	foreach( idx, line in AdminSystem.HELP_TEXT )
		player.Print( line, 2 );
}
